  ...
  return (
    ...
    >
      <div style={{ maxWidth: 360, width: '100%' }}>
        ...
        >
          Sign in to practice your part.
        </p>

        {status === 'sent' ? (
          <div
            style={{
              background: 'rgba(155,106,216,0.1)',
              border: '1px solid rgba(155,106,216,0.3)',
              borderRadius: 12,
              padding: 16,
              textAlign: 'center',
              fontSize: 13,
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 10,
                border: 'none',
                background: status === 'sending' ? 'rgba(155,106,216,0.4)' : '#9B6AD8',
                color: '#fff',
                fontSize: 14,
                fontWeight: 600,
